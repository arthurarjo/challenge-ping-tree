...
router.set('/route', { POST: api.visitHandler })
router.set('/api/targets', { POST: api.createTarget, GET: api.getAllTargets })
router.set('/api/target/:id', { GET: api.getTarget, POST: api.updateTarget })
